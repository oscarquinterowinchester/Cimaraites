    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                ...
                <div class="sidebar-brand-text mx-3">CimaRaites <sup>Admin</sup></div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Visualizaciones:</h6>
                        <a class="collapse-item" href="solicitudes.php">Solicitudes</a>
                        <a class="collapse-item" href="consultaUsuarios.php">Consultar </a>
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                while($row = mysqli_fetch_array($datos)){
                                ?>
                                <a class="dropdown-item d-flex align-items-center" href="visualizar.php?ID=<?php echo $row['id_usuario'] ?>" >
